        ...
        <footer>
            <div className="container py-4 py-lg-5">
                <div className="row justify-content-center">
                    <div className="col-4 col-md-4 text-center text-lg-start d-flex flex-column item">
                        <h3 className="fs-6 text-black">Services</h3>
                        <ul className="list-unstyled">
                            <p className="text-muted copyright">We provide variety of services from
                                design to development and providing configured Version Control Systems.</p>
                        </ul>
                    </div>
                    <div className="col-4 col-md-4 text-center text-lg-start d-flex flex-column item">
                        <h3 className="fs-6 text-black">Careers</h3>
                        <ul className="list-unstyled">
                            <p className="text-muted copyright">Contact me for job opportunities and participating on the development</p>
                        </ul>
                    </div>
                    <div
                        className="col-4 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social">
                        <div className="fw-bold d-flex align-items-center mb-2">
                            <span className="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center bs-icon me-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-bezier fs-5">
                        ...
                        <p className="text-muted copyright">A place where you can develop, code, and show others your cool projects.</p>
                    </div>
                </div>
                <div className="d-flex justify-content-between align-items-center pt-3">
                    <p className="mb-0">Copyright © 2022 MVCS</p>
