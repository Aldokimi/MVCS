"""
Django settings for mvcs project.
...
SECRET_KEY = 'django-insecure-pzir@=1$!kt0r!c(^-4ftq_x(j3*1tpnkei0v0l1e_*5!!bq_n'
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': datetime.timedelta(days=(365*100)),
}
